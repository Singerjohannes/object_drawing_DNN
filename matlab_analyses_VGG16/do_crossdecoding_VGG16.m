...
for i = 1:n_iter
    ...
    % select training data for all depictionsw
    ...
    predicted_label_photo_drawing = svmpredict(label_test,data_test_all(:,:,2),model_photo,'-q');
    predicted_label_photo_sketch = svmpredict(label_test,data_test_all(:,:,3),model_photo,'-q');
    predicted_label_drawing_sketch = svmpredict(label_test,data_test_all(:,:,3),model_drawing,'-q');
